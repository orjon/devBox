...
- Display user info: email, name, avatar (GitHub, Google or initials), account creation date, and last logged in date.
...
- Avatar logic: Use GitHub or Google avatar from OAuth if available, otherwise generate initials from name/email
- Change password button should only appear for users who signed up with email/password (not GitHub or Google OAuth)
