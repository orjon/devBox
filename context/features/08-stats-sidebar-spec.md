...
- Favourites and Recents should be under the heading Collections.
- Add "View all collections" link under the collections list that goes to /collections
- Keep the star icons for favorite collections but for recents, each collection should show a colored rounded square based on the most-used item type in that collection
